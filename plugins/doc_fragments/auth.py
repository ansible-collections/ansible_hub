...
options:
  ah_host:
    description:
    - URL to Automation Hub instance.
  ...
  ah_path_prefix:
    description:
    - API path used to access the API resources.
    - For galaxy_ng this is either C(automation-hub) or the custom prefix used on install with C(GALAXY_API_PATH_PREFIX).
    - For Automation Hub this is C(galaxy).
    type: str
    default: 'galaxy'
"""
