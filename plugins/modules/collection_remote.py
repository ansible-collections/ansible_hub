...
options:
  ...
  client_key:
    description:
      ...
      - Mutually exclusive with O(client_key_path)
    type: str
  client_cert:
    description:
      - A PEM encoded client certificate used for authentication.
      - Mutually exclusive with O(client_cert_path)
    type: str
  ca_cert:
    description:
      - A PEM encoded CA certificate used for authentication.
      - Mutually exclusive with O(ca_cert_path)
    type: str
  client_key_path:
    description:
      - Path to a PEM encoded private key file used for authentication.
      - Mutually exclusive with O(client_key)
    type: str
  client_cert_path:
    description:
  ...
  ca_cert_path:
    description:
      ...
      - Mutually exclusive with O(ca_cert)
    type: str
  ...
  state:
    description:
      - If V(absent), then the module deletes the remote repository.
      - The module does not fail if the remote repository does not exist because the state is already as expected.
      - If V(present), then the module updates the description and README file for the remote repository.
    type: str
    default: present
