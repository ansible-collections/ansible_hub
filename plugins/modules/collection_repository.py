...
options:
    ...
    retain_repo_versions:
      description:
        ...
        - Default is V(0) which retains all versions.
      type: int
      default: 0
    pulp_labels:
    ...
    distribution:
      ...
      suboptions:
        ...
        state:
          description:
            - If V(absent), then the module deletes the distribution.
            - If V(present), then the module creates or updates the distribution.
          type: str
    ...
    state:
      description:
        - If V(absent), then the module deletes the repository and its distribution.
        - If V(present), then the module updates the repository.
      type: str
      choices: ["present", "absent"]
      default: present
...
from ..module_utils.ah_pulp_object import (AHPulpAnsibleDistribution,
                                           AHPulpAnsibleRemote,
