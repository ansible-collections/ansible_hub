...
options:
  ...
  readme:
    description:
      ...
      - Mutually exclusive with the O(readme_file) option.
    type: str
  readme_file:
    description:
      - Path to a README file in Markdown format to associate with the repository.
      - Mutually exclusive with the O(readme) option.
    type: path
  state:
    description:
      ...
      - If V(present), then the module sets the description and README file for the repository.
    type: str
    default: present
